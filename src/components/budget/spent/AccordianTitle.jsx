...
function CategoryTitle({ info, isOpen, setIsOpen }) {
  ...
  return (
    <div className="flex justify-between w-full">
      <div className="flex justify-between items-baseline space-x-4 w-full px-4">
        <p className="text-xl capitalize md:text-3xl">{categoryName}</p>
        <p
          style={{
            color: percentSpent > 100 ? "#D22B2B" : `#48ff00`,
          }}
          className="text-[#48ff00c2] text-base md:text-2xl"
        >
